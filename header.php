      ...
      <div class="row">
        ...
        <div id="menu" class="col s-col20 background-green border-left u-align-center font-sans flex-center">
          <ul>
            ...
            <li <?php menu_active('journal', $active_slug, 'menu-item'); ?>><a href="<?php echo home_url('journal/'); ?>"><?php echo __('[:es]Journal[:en]Journal'); ?></a></a></li>
            <li <?php menu_active('recipe', $active_slug, 'menu-item'); ?>><a href="<?php echo home_url('recipes/'); ?>"><?php echo __('[:es]Recetas[:en]Recipes'); ?></a></a></li>
